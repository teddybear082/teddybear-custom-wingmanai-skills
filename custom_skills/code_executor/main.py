...
class CodeExecutor(Skill):
    ...
    def __init__(
        ...
        self.skill_env_python = os.path.join(get_custom_skills_dir(), "code_executor", "python-embedded", "python.exe")
        self.installed_packages_file = os.path.join(get_custom_skills_dir(), "code_executor", f"installed_packages_{self.wingman.name}.txt")
    ...
    async def execute_tool(
        ...
        benchmark.start_snapshot(f"CodeExecutor: {tool_name}")
